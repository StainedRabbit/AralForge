...
const LESSON_EDITOR: WorkspaceResource[] = ['users','profiles','schedules','enrollments','gradeCategories','gradeItems',...MODULES,'lessonAssets','activities','activityQuestions','activityChoices','activityMatchingPairs','problems','testCases','assessments','questions','choices']

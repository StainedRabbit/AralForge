...
def teacher_dashboard(request):
    ...
    return {
        ...
        'metrics': {
            ...
            'paid_published_modules': Module.objects.filter(is_paid=True, is_published=True).count(),
            ...
            'active_module_grants': ModuleAccess.objects.filter(is_active=True).count(),
